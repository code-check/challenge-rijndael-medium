## rijndael
Rijndael, commonly referred to as the ***Advanced Encryption Standard*** (AES), is a specification for encrypting data. Solve the challenge to implement this cipher and pass [tests](rijndael_test.go).

## Challenge Description
### Step 1: Encryption
Create your encrypt function in [rijndael.go](rijndael.go) under `encrypt`.
...
### Step 2: Decryption
Create your decrypt function in [rijndael.go](rijndael.go) under `decrypt`.
This function will be called from the test cases with the following parameters;
- `byte`
